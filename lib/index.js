...
var addCommitBranchInfoP = function (commit) {
    return new Promise(function (resolve, reject) {
        var revNameCommand = child_process_1.spawn('git', ['name-rev', commit.hash]);
        var revNameResult = '';
        revNameCommand.stdout.on('data', function (data) {
            revNameResult += data.toString();
        });
        revNameCommand.on('error', function (error) {
            console.log('error', error);
            reject(error);
        });
        revNameCommand.on('close', function (code) {
            resolve(__assign(__assign({}, commit), { branchInfo: helpers_1.getBranchInfoFromNameRev(revNameResult) }));
            return code;
        });
    });
};
var ensureCommitsInfo = function (commits) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                commitsP = commits.map(addCommitBranchInfoP);
                return [4 /*yield*/, Promise.all(commitsP)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var getLog = function () { return __awaiter(void 0, void 0, void 0, function () {
    var commits, ensuredCommits, branches, commitCollection;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                Object.keys(branches).map(function (branchName) {
                    console.log(chalk_1.default.magenta.bold(branchName));
                    branches[branchName].map(function (commitHash) {
                        var commit = commitCollection[commitHash];
                        console.log(chalk_1.default.dim.white(commit.authorDate.split(' ')[0]) + " " + chalk_1.default.bold.white(commit.subject));
                        commit.files.map(function (file, i) {
                            ...
                            switch (status) {
                                case 'M':
                                    ...
                                    break;
                                case 'D':
                                    console.log(chalk_1.default.red("  D " + file));
                                    break;
                                case 'A':
                                    console.log(chalk_1.default.green("  A " + file));
                                    break;
                            }
                        });
                    });
