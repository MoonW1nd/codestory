...
var getLog = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, commits, repositoryUrl, ensuredCommits, branches, commitCollection, branchNames;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!!options.author) return [3 /*break*/, 2];
                _a = options;
                return [4 /*yield*/, helpers_1.runCommand("git config --get user.name")];
            case 1:
                _a.author = _b.sent();
                _b.label = 2;
            case 2: return [4 /*yield*/, gitlog_1.gitlogPromise(options)];
            case 3:
                commits = _b.sent();
                return [4 /*yield*/, getRepositoryUrl()];
            case 4:
                repositoryUrl = _b.sent();
                return [4 /*yield*/, ensureCommitsInfo(commits)];
            case 5:
                ensuredCommits = _b.sent();
                branches = {};
                commitCollection = {};
